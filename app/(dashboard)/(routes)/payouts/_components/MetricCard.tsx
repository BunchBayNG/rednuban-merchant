...
export function MetricCard({ metric }: MetricCardProps) {
  ...
  useEffect(() => {
    const supported = {
      "distinctive-vnubans": "/api/analytics/payouts/count-summary",
      "pending-notifications": "/api/analytics/payouts/count-summary",
      "successful-amount": "/api/analytics/payouts/successful-volume",
    };
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (metric.id === "successful-amount") {
        ...
        const defaultValue = metric.id === "successful-amount" ? "₦0.00" : "0";
