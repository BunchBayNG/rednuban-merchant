...
const ChartComponent = () => {
  ...
  const [, setHoveredData] = useState<{ revenue: number; sales: number; month: string } | null>(null);
        ...
        <div className="flex space-x-8">
          <div>
            <div className="flex items-center mb-1 gap-1">
              <TotalValue/>
              <span className="text-sm font-medium text-[#640400]">Transaction Volume</span>
            </div>
          ...
          <div>
            <div className="flex items-center mb-1 gap-1">
              <TransactionCount/>
              <span className="text-sm font-medium text-[#C80000]">New vNUBANs Created</span>
            </div>
            <div className="text-xs ">12.04.2022 - 12.06.2022</div>
          </div>
        </div>
