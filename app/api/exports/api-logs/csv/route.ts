...
export async function GET(request: NextRequest) {
  try {
    ...
    const baseApiUrl = "https://redcollection.onrender.com/api/v1/exports/api-logs/csv";
    ...
    const filename = headers.get("content-disposition")?.match(/filename="(.+)"/)?.[1] || `api-logs_${new Date().toISOString().split("T")[0]}.csv`;
